...
import Sidebar from '@/Components/Sidebar/Guru/Sidebar.vue';
...
import SaludoOpciones from '@/Components/header/guru/SaludoOpciones.vue';
import CardHistorial from '@/Components/Dashboard/Guru/CardHistorial.vue';
                ...
                <div class="flex gap-[10px] ">
                    <div class="left w-[35%] h-[85vh] flex flex-col gap-5 justify-between px-3">
                        <div class="saludo-btn flex flex-col justify-center items-center gap-3">
                            ...
                            <button
                                class="flex items-center justify-center gap-3 shadow-guru bg-guru-primary py-[10px] px-[40px] rounded-xl hover:shadow-lg">
                                Vender con POS
                    ...
                    <div class="right w-[65%] px-3 flex flex-col ">
                        <div class="encabezadoPanelDerecho">
                            <div class="encabezado flex gap-2 items-center bg-transparent">
                                <div
                                    class="gota h-[20px] w-[20px] rounded-full bg-guru-primary shadow-guru">
                                </div>
