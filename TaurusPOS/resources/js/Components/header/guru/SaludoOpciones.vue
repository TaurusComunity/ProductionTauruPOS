<template>
    <header class="w-full h-[100%] flex justify-between mb-[40px]">
                    <div class="date flex gap-3 items-center">
                        <div class="dia flex items-center justify-center font-semibold h-10 w-7 shadow-guru bg-guru-primary rounded-full"
                            id="dia">
                            {{ dia }}
                        </div>
                        ...
                        <div class="separador h-8 w-[2px] bg-guru-primary rounded-lg"></div>
                    ...
                    <div class="options-user flex gap-2 items-center justify-center">
                        ...
                        <div class="logo flex gap-3 items-center">
                            <div class="gota h-10 w-10 shadow-guru bg-guru-primary rounded-full"></div>
                            <div class="logo">
